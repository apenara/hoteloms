...
const ESTADOS = Object.entries(ROOM_STATES).reduce((acc, [key, value]) => ({
  ...acc,
  [key]: {
    label: value.label,
...
export default function HotelDashboard() {
  ...
  return (
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Dashboard Nombre del Hotel <NotificationsDialog hotelId={user?.hotelId} /></CardTitle>
