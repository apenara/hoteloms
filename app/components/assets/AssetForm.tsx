...
export default function AssetForm({
  ...
  const generateAssetCode = async () => {
    ...
    try {
      ...
      const newCode = `${categoryPrefix}-${String(nextNumber).padStart(
        4,
        "0"
      )}`;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (selectedDocuments.length > 0) {
        const newDocumentUrls = await uploadFiles(
          selectedDocuments,
          "documents"
        );
                  ...
                  value={
                    asset.acquisitionDate
                      ? asset.acquisitionDate.seconds
                        ? new Date(asset.acquisitionDate.seconds * 1000)
                            .toISOString()
                            .split("T")[0]
                  ...
                  value={
                    asset.warrantyExpiryDate
                      ? asset.warrantyExpiryDate.seconds
                        ? new Date(asset.warrantyExpiryDate.seconds * 1000)
                            .toISOString()
                            .split("T")[0]
                        : ""
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    document.getElementById("asset-images")?.click()
                  }
                  className="w-full"
                >
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    document.getElementById("asset-documents")?.click()
                  }
                  className="w-full"
                >
                  <Upload className="h-4 w-4 mr-2" />
