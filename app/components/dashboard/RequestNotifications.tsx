...
export function RequestNotifications({ hotelId }: RequestNotificationsProps) {
  const { notifications, markAsRead } = useReceptionNotifications(hotelId);
            ...
            >
              ...
              <div className="flex-1 space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  {notification.message || `Solicitud: ${notification.type}`}
                </p>
